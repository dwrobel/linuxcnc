...
%global date 20220109
%global commit0 b98ed1c1515aa88e270062646de11a0e37fb1382
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.65.%{date}git%{shortcommit0}%{?dist}
...
Patch16:   %{name}-0016-Update-qtplasma-documentation-THC-Velocity-Lock.patch
Patch17:   %{name}-0017-Fix-qtplasma-documentation-unify-VELOCITY-ANTI-DIVE.patch
Patch18:   %{name}-0018-Fix-returning-address-of-local-variable-in-get_buffe.patch
Patch19:   %{name}-0019-Fix-qtplasma-setMaximum-argument.patch
