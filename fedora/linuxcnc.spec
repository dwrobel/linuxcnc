...
%global commit0 deddd4e4ddb3a0197deb815ffd58d82e59afda3a
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.30.%{date}git%{shortcommit0}%{?dist}
...
Patch8:   %{name}-0008-Add-vectorized-version-of-linuxcnc-icon.patch
