...
%global date 20200530
%global commit0 ade093383757f4c038b1b462897823acb93a5f6b
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.31.%{date}git%{shortcommit0}%{?dist}
...
Patch3:   %{name}-0003-Improve-searching-LinuxCNC-components-from-GNOME-men.patch
...
Patch11:   %{name}-0011-Add-vectorized-version-of-linuxcnc-icon.patch
