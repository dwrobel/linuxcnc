...
%global commit0 9876b05036b607563f99efa07ea0af04ec3d4e79
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.22.%{date}git%{shortcommit0}%{?dist}
...
Patch6:   %{name}-0006-Fix-TypeError-a-bytes-like-objectis-required-not-str.patch
Patch7:   %{name}-0007-Fix-using-dumpfullversion-for-old-compilers.patch
