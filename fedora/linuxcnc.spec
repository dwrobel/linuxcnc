...
%global commit0 1b9335f831ced0ae2c936aadc27edb457a9b9018
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.45.%{date}git%{shortcommit0}%{?dist}
...
Patch1:   %{name}-0001-Allow-to-overwrite-default-CXXFLAGS-no-psabi-std-gnu.patch
Patch2:   %{name}-0002-Make-sure-all-compilations-honors-CPPFLAGS.patch
Patch3:   %{name}-0003-Use-TEMP_FAILURE_RETRY-to-handle-EINTR-properly.patch
Patch4:   %{name}-0004-Remove-unused-thread_lock.patch
Patch5:   %{name}-0005-Unify-FIFO_SCHED-between-root-and-non-root-user.patch
Patch6:   %{name}-0006-Always-report-realtime-from-rtapi_is_realtime.patch
Patch7:   %{name}-0007-Disable-using-iptables-work-in-progress.patch
Patch8:   %{name}-0008-rootless-incr_io_usage.patch
Patch9:   %{name}-0009-rootless-incr_mem_usage.patch
Patch10:   %{name}-0010-Remove-direct-usage-of-inb-outb.patch
Patch11:   %{name}-0011-Run-tests-in-verbose-mode-and-with-timeout-travis.patch
Patch12:   %{name}-0012-Add-halgraph.patch
...
%exclude %{_datadir}/applications/linuxcnc-documentation-es.desktop
%exclude %{_datadir}/applications/linuxcnc-gcoderef.desktop
%exclude %{_datadir}/applications/linuxcnc-gcoderef-es.desktop
%exclude %{_datadir}/applications/linuxcnc-gcoderef-fr.desktop
%exclude %{_datadir}/applications/linuxcnc-gettingstarted-es.desktop
...
%exclude %{_datadir}/applications/linuxcnc-gettingstarted-cn.desktop
%{_datadir}/doc/%{name}
...
%files doc-es
%{_datadir}/applications/linuxcnc-documentation-es.desktop
%{_datadir}/doc/linuxcnc/LinuxCNC_Getting_Started_es.pdf
%{_datadir}/applications/linuxcnc-gettingstarted-es.desktop
%{_datadir}/doc/linuxcnc/LinuxCNC_Documentation_es.pdf
%{_datadir}/applications/linuxcnc-gcoderef-es.desktop
