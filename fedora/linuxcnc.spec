...
%global commit0 1fde659330ad460fe54826580f95dc876d7badc9
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.86.%{date}git%{shortcommit0}%{?dist}
...
Patch3:   %{name}-0003-Allow-to-overwrite-default-CXXFLAGS-no-psabi-std-gnu.patch
...
Patch15:   %{name}-0015-Fix-python-shebang-amibiguities-for-craftsman.patch
Patch16:   %{name}-0016-Switch-to-python3-for-fanuc_200f.py.patch
Patch17:   %{name}-0017-Fix-use-after-free-in-sendkeys.c.patch
