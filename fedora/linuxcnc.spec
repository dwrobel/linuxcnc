...
%global commit0 a48a535934a4f885c4ddbda158ead81e49c2266b
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.77.%{date}git%{shortcommit0}%{?dist}
...
Patch15:   %{name}-0015-halshow-attempt-to-fix-icon-path.patch
