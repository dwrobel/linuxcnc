...
%global commit0 1fed7e94284f8d3a561af497813f512bc90bda8a
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.35.%{date}git%{shortcommit0}%{?dist}
...
Patch2:   %{name}-0002-Use-distinguishable-error-messages.patch
