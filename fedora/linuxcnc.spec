...
%global commit0 dfe0260cd122719e8c5366b07c549e77cd724c0f
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.71.%{date}git%{shortcommit0}%{?dist}
...
# Unmerged upstream fix for correct python shebang
# Patch0:        https://patch-diff.githubusercontent.com/raw/LinuxCNC/linuxcnc/pull/1318.patch#/%{name}-fix-python-shebang.patch
