...
%global date 20200709
%global commit0 774cc04e6c4a12d446328d829939147c74b2bc98
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.38.%{date}git%{shortcommit0}%{?dist}
...
Patch9:   %{name}-0009-Run-tests-in-verbose-mode-and-with-timeout.patch
