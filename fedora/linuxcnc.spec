...
%global commit0 3db322c0be43fa330fac7f1af9752b72a8c84fd2
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.61.%{date}git%{shortcommit0}%{?dist}
...
Patch15:   %{name}-0015-Fix-QTimer-start-argument.patch
Patch16:   %{name}-0016-Fix-QColor-argument.patch
Patch17:   %{name}-0017-Fix-addWidget-argument.patch
Patch18:   %{name}-0018-Fix-drawEllipse-arguments.patch
Patch19:   %{name}-0019-Fix-QTimer-start-argument-HALPIN_CYCLE_TIME.patch
Patch20:   %{name}-0020-Improve-error-logging-by-adding-full-python-tracebac.patch
