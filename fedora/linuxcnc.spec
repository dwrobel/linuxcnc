...
%global commit0 03ab5e6adf45b18f975c5717093a85c1abc1d702
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.43.%{date}git%{shortcommit0}%{?dist}
...
Patch13:   %{name}-0013-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch14:   %{name}-0014-Increase-arc-voltage-display-precision.patch
Patch15:   %{name}-0015-Run-tests-in-verbose-mode-and-with-timeout-github.patch
