...
%global commit0 1d134062de0a2e524abc512d51f7f7e75f55b517
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.27.%{date}git%{shortcommit0}%{?dist}
...
Patch1:   %{name}-0001-Fix-desktop-files.patch
Patch2:   %{name}-0002-Improve-searching-LinuxCNC-components-from-GNOME-men.patch
Patch3:   %{name}-0003-Make-sure-all-compilations-honors-CPPFLAGS.patch
Patch4:   %{name}-0004-Remove-duplicate-checking-for-dblatex.patch
Patch5:   %{name}-0005-Remove-import-of-defusedexpat.patch
Patch6:   %{name}-0006-Disable-using-iptables.patch
Patch7:   %{name}-0007-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch8:   %{name}-0008-Add-bigger-linuxcnc-logo.patch

%{!?tcl_version: %global tcl_version %(echo 'puts $tcl_version' | tclsh)}
%{!?tcl_sitearch: %global tcl_sitearch %{_libdir}/tcl%{tcl_version}}

%global the_icon_file %{_datadir}/icons/hicolor/256x256/apps/linuxcncicon.png
...
# install icon file
install -p -D -m 0644 debian/extras/usr/share/pixmaps/linuxcncicon.png \
