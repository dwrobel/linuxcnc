...
%global commit0 6dc7ceb646c8e9378e20f842ef6aeadbbfc0ebe6
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.18.%{date}git%{shortcommit0}%{?dist}
...
Patch8:   %{name}-0008-Fix-generating-pdf-documentation-using-python3.patch
