...
%global commit0 89a41a275ba34d6a6797898280964abd6336b812
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.73.%{date}git%{shortcommit0}%{?dist}
...
Patch2:   %{name}-0002-Do-not-use-ax_python_devel-for-version-checking.patch
...
Patch14:   %{name}-0014-Update-configure.ac-to-support-autoconf-2.71.patch
Patch15:   %{name}-0015-Remove-executable-attribute-from-asciidoc.js.patch
