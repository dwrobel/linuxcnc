...
%global date 20211231
%global commit0 67c373018761e6b2f994a79effd8e6576ef5aad2
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.62.%{date}git%{shortcommit0}%{?dist}
...
Patch2:   %{name}-0002-Disable-checking-version-for-python-development-pack.patch
Patch3:   %{name}-0003-Add-halgraph.patch
...
Patch14:   %{name}-0014-pncconf-Add-PLASMA_DW_34-support-for-7i92-card.patch
Patch15:   %{name}-0015-Fix-addWidget-argument.patch
Patch16:   %{name}-0016-Fix-drawEllipse-arguments.patch
Patch17:   %{name}-0017-Fix-QTimer-start-argument-HALPIN_CYCLE_TIME.patch
Patch18:   %{name}-0018-Improve-error-logging-by-adding-full-python-tracebac.patch
Patch19:   %{name}-0019-Allow-to-use-float-for-QSlider.patch
...
%changelog
* Fri Dec 31 2021 Damian Wrobel <dwrobel@ertelnet.rybnik.pl> - 2.9.0-0.62.20211231git67c3730
