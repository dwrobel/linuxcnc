...
%global commit0 709d0fd2dad9a94debdd757371249ef933f28ae5
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.16.%{date}git%{shortcommit0}%{?dist}
...
Patch14:   %{name}-0014-Fix-SyntaxWarning-is-with-a-literal-pyngcgui.py.patch
Patch15:   %{name}-0015-Remove-relying-on-unversioned-python.patch
