...
%global commit0 0558a25c3093b333bffc40ed6512753bd2f7bfc9
...
Patch2:        %{name}-0002-Fix-readline-v5-GPL-2-license-compatiblity-checking.patch
Patch3:        %{name}-0003-Fix-honoring-CFLAGS-CXXFLAGS-CPPFLAGS-passed-to-the-.patch
Patch4:        %{name}.diff
