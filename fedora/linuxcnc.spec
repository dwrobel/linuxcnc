...
%global commit0 a21d3006b754657ddac5a7d5b999fb0698dbcd55
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.87.%{date}git%{shortcommit0}%{?dist}
...
Patch16:   %{name}-0016-Fix-use-after-free-in-sendkeys.c.patch
