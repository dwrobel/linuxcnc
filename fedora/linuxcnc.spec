...
%global commit0 358a08fe5531d652d049e33274f5170ba7982621
...
Patch1:   %{name}-0001-Fix-build-error.patch
Patch2:   %{name}-0002-Fix-realtime-linuxcnc-script-installation.patch
Patch3:   %{name}-0003-Add-support-for-checking-text-x-script.python-in-pyc.patch
Patch4:   %{name}-0004-Disable-checking-version-for-python-development-pack.patch
Patch5:   %{name}-0005-Allow-to-overwrite-default-CXXFLAGS-no-psabi-std-gnu.patch
...
Patch15:   %{name}-0015-Add-halgraph.patch
...
%changelog
* Fri Nov 19 2021 Damian Wrobel <dwrobel@ertelnet.rybnik.pl> - 2.9.0-0.56.20211111git358a08f
