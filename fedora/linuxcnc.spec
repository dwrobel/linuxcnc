...
%global commit0 0c5769af756db967ad9b404042b06240df3aa64c
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.11.%{date}git%{shortcommit0}%{?dist}
...
Patch6:   %{name}-0006-Make-build-process-more-verbose.patch
Patch7:   %{name}-0007-Add-pycheck-Python-check-Makefile-target.patch
Patch8:   %{name}-0008-hal-drivers-python3-compatibility.patch
Patch9:   %{name}-0009-Add-hal-to-pycheck-verification.patch
Patch10:   %{name}-0010-add-rpm-spec-file-and-patch-files-generator.patch
