...
%global commit0 21107ad309a892cfd0b1dc5246135d2d18e8afdd
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.21.%{date}git%{shortcommit0}%{?dist}
...
Patch2:   %{name}-0002-Revert-Revert-Fix-honoring-C-CXX-CPP-LD-FLAGS-passed.patch
...
Patch5:   %{name}-0005-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch6:   %{name}-0006-Fix-generating-html-documentation-using-python3.patch
Patch7:   %{name}-0007-Fix-TypeError-a-bytes-like-objectis-required-not-str.patch
