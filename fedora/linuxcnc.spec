...
%global commit0 cd053635eafb7963a0f66836acf30d87b2102d1c
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.75.%{date}git%{shortcommit0}%{?dist}
...
Patch15:   %{name}-0015-Revert-Merge-pull-request-1569-from-hansu-halshow-st.patch
Patch16:   %{name}-0016-Disable-Always-on-top-by-default-fixes-1589.patch
