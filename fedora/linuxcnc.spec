...
%global commit0 7a6d776af165b59aeb63f39fe49d6e5c464c0c69
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.10.0
Release:       0.91.%{date}git%{shortcommit0}%{?dist}
...
Patch14:   %{name}-0014-Fix-canterp.so-installation.patch
Patch15:   %{name}-0015-Add-timings-for-DM860T-stepper-driver.patch
