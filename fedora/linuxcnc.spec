...
%global commit0 9b27ae33afbcb5a2fb55c841bb0c11bf041d2072
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.42.%{date}git%{shortcommit0}%{?dist}
...
Patch1:   %{name}-0001-Make-sure-all-compilations-honors-CPPFLAGS.patch
Patch2:   %{name}-0002-rootless-incr_io_usage.patch
Patch3:   %{name}-0003-rootless-incr_mem_usage.patch
Patch4:   %{name}-0004-Use-TEMP_FAILURE_RETRY-to-handle-EINTR-properly.patch
Patch5:   %{name}-0005-Unify-FIFO_SCHED-between-root-and-non-root-user.patch
Patch6:   %{name}-0006-rootless-rtapi_is_realtime-work-in-progress.patch
Patch7:   %{name}-0007-Remove-direct-usage-of-inb-outb.patch
Patch8:   %{name}-0008-Disable-using-iptables.patch
Patch9:   %{name}-0009-Run-tests-in-verbose-mode-and-with-timeout-travis.patch
Patch10:   %{name}-0010-Add-halgraph.patch
Patch11:   %{name}-0011-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch12:   %{name}-0012-Increase-arc-voltage-display-precision.patch
