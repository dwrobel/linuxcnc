...
%global commit0 cc3a802ab11ab880575cd969e3f2d8a23e144a73
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.33.%{date}git%{shortcommit0}%{?dist}
...
Patch3:   %{name}-0003-Make-sure-all-compilations-honors-CPPFLAGS.patch
Patch4:   %{name}-0004-rootless-incr_io_usage.patch
Patch5:   %{name}-0005-rootless-incr_mem_usage.patch
...
Patch8:   %{name}-0008-rootless-rtapi_is_realtime-work-in-progress.patch
Patch9:   %{name}-0009-Remove-direct-usage-of-inb-outb.patch
Patch10:   %{name}-0010-Disable-using-iptables.patch
Patch11:   %{name}-0011-Run-tests-in-verbose-mode-and-with-timeout.patch
Patch12:   %{name}-0012-Add-halgraph.patch
Patch13:   %{name}-0013-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch14:   %{name}-0014-Run-tests-in-verbose-mode-and-with-timeout.patch
