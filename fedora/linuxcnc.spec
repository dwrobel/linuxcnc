...
Name:          linuxcnc
Version:       2.9.0
Release:       0.49.%{date}git%{shortcommit0}%{?dist}
...
Patch15:   %{name}-0015-Run-tests-in-verbose-mode-and-with-timeout-travis.patch
Patch16:   %{name}-0016-Run-tests-in-verbose-mode-and-with-timeout-github.patch
Patch17:   %{name}-0017-add-rpm-spec-file-and-patch-files-generator.patch
