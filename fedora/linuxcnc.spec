...
%global commit0 6d8161a8581e6217e8e5dbd04612fa0a369eba08
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.10.0
Release:       0.100.%{date}git%{shortcommit0}%{?dist}
...
Patch1:   %{name}-0001-Fix-SameFileError-exception-on-axis-GUI.patch
Patch2:   %{name}-0002-Add-timings-for-DM860T-stepper-driver.patch
Patch3:   %{name}-0003-Add-halgraph.patch
Patch4:   %{name}-0004-Allow-to-overwrite-default-CXXFLAGS.patch
...
Patch14:   %{name}-0014-pncconf-Avoid-using-hardcoded-number-of-pins-24.patch
...
%changelog
* Wed Dec 13 2023 Damian Wrobel <dwrobel@ertelnet.rybnik.pl> - 2.10.0-0.100.20231212git7d9b5e5
- Update to the latest version
- Remove patches upstream merged
- Add patch to fix axis GUI
