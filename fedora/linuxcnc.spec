...
%global date 20200715
%global commit0 a695f97fde46792efcab77ccc8c84aa1f2e8c870
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.40.%{date}git%{shortcommit0}%{?dist}
...
Patch12:   %{name}-0012-Run-tests-in-verbose-mode-and-with-timeout-github.patch
