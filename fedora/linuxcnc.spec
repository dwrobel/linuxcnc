...
%global commit0 1312cfa6a5c714c4b4db16d29ada048bb060bc24
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.10.%{date}git%{shortcommit0}%{?dist}
...
Patch4:   %{name}-0004-Fix-tests-motion-g0.patch
Patch5:   %{name}-0005-Fix-running-travis-install-build-deps.sh.patch
Patch6:   %{name}-0006-Fix-honoring-C-CXX-CPP-LD-FLAGS-passed-to-the-config.patch
