...
%global commit0 759ec2dbe0538dc70a621b87655b511b24283b3d
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.6.%{date}git%{shortcommit0}%{?dist}
...
Patch3:   %{name}-0003-Make-build-process-more-verbose.patch
Patch4:   %{name}-0004-Fix-compiling-strsep-for-uspace.patch
Patch5:   %{name}-0005-Fix-threads.0-test.patch
Patch6:   %{name}-0006-Fix-tests-abort-feed-rate.patch
Patch7:   %{name}-0007-Fix-tests-build-header-sanity.patch
Patch8:   %{name}-0008-Fix-tests-halmodule.0.patch
Patch9:   %{name}-0009-Fix-running-travis-install-build-deps.sh.patch
Patch10:   %{name}-0010-Fix-tests-halmodule.1.patch
Patch11:   %{name}-0011-Fix-tests-ccomp-early-exit.patch
Patch12:   %{name}-0012-Fix-tests-halui-jogging.patch
Patch13:   %{name}-0013-Fix-tests-halui-mdi.patch
Patch14:   %{name}-0014-Fix-tests-hard-limits.patch
Patch15:   %{name}-0015-Fix-tests-hm2-idrom.patch
Patch16:   %{name}-0016-Fix-tests-interp-bad.patch
Patch17:   %{name}-0017-Fix-tests-interp-good.patch
Patch18:   %{name}-0018-Fix-tests-interp-m98m99-12-M99-endless-main-program.patch
Patch19:   %{name}-0019-Fix-tests-interp-mdi-oword-m66.patch
Patch20:   %{name}-0020-Fix-tests-interp-oword-mdi-sub-update.patch
Patch21:   %{name}-0021-Fix-tests-interp-python-error.patch
Patch22:   %{name}-0022-Fix-tests-interp-subroutine-return.patch
Patch23:   %{name}-0023-add-rpm-spec-file-and-patch-files-generator.patch
...
%{_bindir}/rotarydelta
%{_bindir}/rs274
%caps(cap_sys_rawio,cap_sys_nice=eip) %{_bindir}/rtapi_app
%{_bindir}/scaragui
%{_bindir}/schedrmt
