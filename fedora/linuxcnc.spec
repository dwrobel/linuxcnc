...
#TODO: temporarly disabled as it fails on rawhide
%global _without_doc %{?_without_doc:0} %{?!_without_doc:1}

%{?python_enable_dependency_generator}

%global date 20200505
%global commit0 a28d412d6697b680d7df5b6af01c927316a95658
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.15.%{date}git%{shortcommit0}%{?dist}
...
Patch2:   %{name}-0002-Fix-compiling-strsep-for-uspace.patch
Patch3:   %{name}-0003-Fix-tests-build-header-sanity.patch
Patch4:   %{name}-0004-Fix-running-travis-install-build-deps.sh.patch
Patch5:   %{name}-0005-Fix-honoring-C-CXX-CPP-LD-FLAGS-passed-to-the-config.patch
Patch6:   %{name}-0006-Make-sure-all-compilation-honors-CPPFLAGS.patch
Patch7:   %{name}-0007-Make-build-process-more-verbose.patch
Patch8:   %{name}-0008-Add-pycheck-Python-check-Makefile-target.patch
Patch9:   %{name}-0009-Fix-halmodule.0-test-for-python3-fixes-818.patch
Patch10:   %{name}-0010-Fix-linking-error-on-gcc10.patch
Patch11:   %{name}-0011-Fix-invalid-syntax-for-python3.patch
Patch12:   %{name}-0012-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch13:   %{name}-0013-Fix-SyntaxWarning-is-not-with-a-literal-for-python3..patch
Patch14:   %{name}-0014-Fix-gcc-version-10-too-old-skipping-hal-user_comps-x.patch
Patch15:   %{name}-0015-Fix-SyntaxWarning-is-with-a-literal-pyngcgui.py.patch
Patch16:   %{name}-0016-Remove-relying-on-unversioned-python.patch
