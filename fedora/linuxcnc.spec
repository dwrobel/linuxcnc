...
%global date 20200628
%global commit0 f414ce9df90d97f17b49195a09d28197331d198b
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.36.%{date}git%{shortcommit0}%{?dist}
...
Patch1:   %{name}-0001-Use-distinguishable-error-messages.patch
...
Patch10:   %{name}-0010-Run-tests-in-verbose-mode-and-with-timeout.patch
Patch11:   %{name}-0011-Add-halgraph.patch
Patch12:   %{name}-0012-Fix-python3-compatibility-for-persistence.py-popupke.patch
Patch13:   %{name}-0013-Run-tests-in-verbose-mode-and-with-timeout.patch
