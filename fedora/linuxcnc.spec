...
%global commit0 b5bdcedbdce5f7ed674f33efe7c44c92badc489a
%global shortcommit0 %(c=%{commit0}; echo ${c:0:7})

Name:          linuxcnc
Version:       2.9.0
Release:       0.24.%{date}git%{shortcommit0}%{?dist}
...
Patch3:   %{name}-0003-Remove-duplicate-checking-for-dblatex.patch
Patch4:   %{name}-0004-Fix-python3-compatibility-for-persistence.py-popupke.patch
...
# install icon files
install -p -D -m 0644 %{name}icon.png %{buildroot}%{main_icon_file}
