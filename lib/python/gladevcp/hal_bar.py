...
class HAL_Bar(Gtk.DrawingArea, _HalWidgetBase):
    ...
    def __init__(self):
        ...
        self.bg_color = Gdk.Color('gray')
        self.z0_color = Gdk.Color('green')
        self.z1_color = Gdk.Color('yellow')
        self.z2_color = Gdk.Color('red')
        self.target_color = Gdk.Color('purple')
        self.target_width = 2
