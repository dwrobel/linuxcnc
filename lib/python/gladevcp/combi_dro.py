...
class Combi_DRO(Gtk.VBox):
    ...
    __gsignals__ = {
                    'clicked': (GObject.SignalFlags.RUN_FIRST, None, (GObject.TYPE_STRING, GObject.TYPE_PYOBJECT)),
                    'units_changed': (GObject.SignalFlags.RUN_FIRST, None, (GObject.TYPE_BOOLEAN,)),
                    'system_changed': (GObject.SignalFlags.RUN_FIRST, None, (GObject.TYPE_STRING,)),
                    'axis_clicked': (GObject.SignalFlags.RUN_FIRST, None, (GObject.TYPE_STRING,)),
    ...
    def __init__(self, joint_number = 0):
        ...
        self.system = "Rel"
        self.homed = False
        self.homed_color = Gdk.Color("green")
        self.unhomed_color = Gdk.Color("red")
        self.abs_color = Gdk.Color("blue")
        self.rel_color = Gdk.Color("black")
        self.dtg_color = Gdk.Color("yellow")
        ...
        self.eventbox.modify_bg(Gtk.StateType.NORMAL, Gdk.color_parse("black"))
        ...
        hbox_up.pack_start(self.main_dro, True, True, 0)
    ...
    def _set_labels(self):
        ...
        self.eventbox.modify_bg(Gtk.StateType.NORMAL, bg_color)
